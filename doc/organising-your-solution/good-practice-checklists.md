...
| 2 | You include a README markdown file, instructing others on how to build and deploy your software solution | ☐ | [*Provide a README file*](provide-a-readme-file-rootfoldernamereadmemd.md) |  |
...
| 4 | You include a *source* folder | ☐ | [*Include a source folder*](create-a-source-folder-rootfoldernamesrc.md) |  |
...
| 6 | You include a *documents* folder | ☐ | [*Include a documents folder*](provide-a-documents-folder-rootfoldernamespecsdocs.md) |  |
| 7 | You include folder for coded tests | ☐ | [*Include a test folder*](provide-a-test-folder-rootfoldernamespecstest.md) |  |
| 8 | You include a *builds* folder | ☐ | [*Include a build folder*](provide-a-build-folder-rootfoldernamebuild.md) |  |
