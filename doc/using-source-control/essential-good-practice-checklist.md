...
| 3 | You follow a documented, well-understood branching strategy. | ☐ | [Follow a branching s trategy](follow-a-branching-strategy.md) |  |
| 4 | You have a versioning strategy that clearly indicates breaking changes in updated versions. | ☐ | [Implement a versioning strat egy](implement-a-versioning-strategy.md) |  |
| 5 | Your write clear commit messages following the conventional commits specification. | ☐ | [Write clear commit m essages](write-clear-commit-messages.md) |  |
