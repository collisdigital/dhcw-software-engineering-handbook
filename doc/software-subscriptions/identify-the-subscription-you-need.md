...
!!! note "**Role** **Product owner** **Scrum team member** **Manual testing** **Test automation** **Web developer** **Mobile developer** **Integration developer** **SQL Database developer**"
    **Subscription(s)** Azure DevOps Basic

    Azure DevOps Basic

    Visual Studio Test Professional or Azure DevOps Basic + Test Plans
    ...
    GitHub CoPilot Business Visual Studio Professional with GitHub Enterprise

    Visual Studio Professional with GitHub Enterprise

    dotUltimate or Rider

    Visual Studio Professional with GitHub Enterprise

    Visual Studio Test Professional or Azure DevOps Basic + Test Plans

    HL7 Edit Licence Azure DevOps Basic
